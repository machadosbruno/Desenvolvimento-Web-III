...
import { Pesquisar, Remover } from "./actions";
...
export default function Livros() {
    ...
    const handleAtualizar = async () => {
        ...
        try {
            const livros = await Pesquisar({ titulo: pesquisaobj.titulo, ano: parseInt(pesquisaobj.anoPublicacao) });
            setDados(livros);
        }
        catch {
            Swal.fire({
